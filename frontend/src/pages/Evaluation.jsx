...
const Evaluation = () => {
  const { negativeFeedbacks, feedbackLoading, user, fetchNegativeFeedbacks, versions, fetchVersions } = useAuth();
  ...
  const handleTrain = () => {
    // Calculate next version based on current latest version
            ...
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold flex items-center gap-2">
                <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm">
                  Next Version: v{latestVersion + 1}.0
                </span>
                <span className="text-muted-foreground text-sm font-normal">
                  ({negativeFeedbacks.length} samples pending)
                </span>
              </h2>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 min-w-fit">
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  Start Training v{latestVersion + 1}.0
                </span>
              </button>
